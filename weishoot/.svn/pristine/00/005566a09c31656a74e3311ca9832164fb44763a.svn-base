...
package com.NationalPhotograpy.weishoot.utils.imageloader.core.imageaware;
 ...
 * {@link com.iss.imageloader.core.ImageLoader ImageLoader}. It can wrap any
 * Android {@link android.view.View View} which can be accessed by
 * {@link #getWrappedView()}. Wrapped view is returned in
 * {@link com.iss.imageloader.core.listener.ImageLoadingListener
...
public interface ImageAware {
    ...
    /**
     * Returns {@linkplain com.iss.imageloader.core.assist.ViewScaleType scale
     * type} which is used for scaling image for this image aware view.
     */
    ViewScaleType getScaleType();

    /**
     * Returns wrapped Android {@link android.view.View View}. Can return
     * <b>null</b> if no view is wrapped.<br />
     * Called on UI thread.
     */
    View getWrappedView();
     ...
     * and fires
     * {@link com.iss.imageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String, android.view.View)
     ...
     * {@linkplain com.iss.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(android.graphics.drawable.Drawable)
     * for empty Uri},
     * {@linkplain com.iss.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(android.graphics.drawable.Drawable)
     * on loading} or
     * {@linkplain com.iss.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(android.graphics.drawable.Drawable)
     * on loading fail}. These drawables can be specified in
     * {@linkplain com.iss.imageloader.core.DisplayImageOptions display options}
     * .<br />
     * Also can be called in
     * {@link com.iss.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.
     *
     ...
     * Called on UI thread to display loaded and decoded image
     * {@link android.graphics.Bitmap} in this image view aware. Actually it's
     * used only in {@link com.iss.imageloader.core.display.BitmapDisplayer
     * BitmapDisplayer}.
     *
