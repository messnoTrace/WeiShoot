 ...
 * {@link com.iss.imageloader.core.imageaware.ImageAware image aware view}
 * during image loading</li>
 * <li>whether stub image will be displayed in
 * {@link com.iss.imageloader.core.imageaware.ImageAware image aware view} if
 * empty URI is passed</li>
 * <li>whether stub image will be displayed in
 * {@link com.iss.imageloader.core.imageaware.ImageAware image aware view} if
 * image loading fails</li>
 * <li>whether {@link com.iss.imageloader.core.imageaware.ImageAware image aware
 * view} should be reset before image loading start</li>
...
public final class DisplayImageOptions {
    ...
    public static class Builder {
         ...
         * {@link com.iss.imageloader.core.imageaware.ImageAware image aware
         * view} during image loading
         *
         ...
         * {@link com.iss.imageloader.core.imageaware.ImageAware image aware
         * view} during image loading. This option will be ignored if
         ...
         * Incoming image will be displayed in
         * {@link com.iss.imageloader.core.imageaware.ImageAware image aware
         * view} if empty URI (null or empty string) will be passed to
         ...
         * Incoming image will be displayed in
         * {@link com.iss.imageloader.core.imageaware.ImageAware image aware
         * view} if some error occurs during requested image loading/decoding.
         *
         * @param imageRes Image resource
         */
         ...
         * {@link DisplayImageOptions.Builder#showImageOnFail(int)} is set.
         */
        ...
        /**
         * Sets whether {@link com.iss.imageloader.core.imageaware.ImageAware
         ...
         * be displayed in
         * {@link com.iss.imageloader.core.imageaware.ImageAware image aware
         * view} but after they'll have been saved in memory cache.
         */
