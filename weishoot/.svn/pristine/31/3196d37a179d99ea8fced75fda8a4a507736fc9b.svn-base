...
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.FlushedInputStream;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.ImageSize;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.LoadedFrom;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.ViewScaleType;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.imageaware.ImageAware;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.imageaware.ImageNonViewAware;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.imageaware.ImageViewAware;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.listener.ImageLoadingListener;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.listener.ImageLoadingProgressListener;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.listener.SimpleImageLoadingListener;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.listener.SyncImageLoadingListener;
import com.NationalPhotograpy.weishoot.utils.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
     ...
     * @param imageAware
     *            {@linkplain com.iss.imageloader.core.imageaware.ImageAware
     ...
     *            {@linkplain com.iss.imageloader.core.imageaware.ImageAware
     *            Image aware view} which should display image
     * @param options {@linkplain com.iss.imageloader.core.DisplayImageOptions
     ...
     * @param listener {@linkplain ImageLoadingListener Listener} for image
     *            loading process. Listener fires events on UI thread.
     * @param progressListener {@linkplain com.iss.imageloader.core.listener.ImageLoadingProgressListener
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            if (options.shouldPostProcess()) {
                ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, imageAware,
                        targetSize, memoryCacheKey, options, listener, progressListener,
                        engine.getLockForUri(uri));
                ProcessAndDisplayImageTask displayTask = new ProcessAndDisplayImageTask(engine,
                        bmp, imageLoadingInfo, defineHandler(options));
            ...
            LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(engine,
                    imageLoadingInfo, defineHandler(options));
            if (options.isSyncLoading()) {
                displayTask.run();
            } else {
                engine.submit(displayTask);
    ...
    public void loadImage(String uri, ImageSize targetImageSize, DisplayImageOptions options,
        ...
        ImageNonViewAware imageAware = new ImageNonViewAware(uri, targetImageSize,
                ViewScaleType.CROP);
     ...
     *            "file:///mnt/sdcard/image.png")
     * @param targetImageSize Minimal size for {@link Bitmap} which will be
     *            returned. Downloaded image will be decoded and scaled to
     *            {@link Bitmap} of the size which is <b>equal or larger</b>
     *            (usually a bit larger) than incoming targetImageSize.
     * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding
     *         was failed or cancelled.
     ...
     * {@link com.iss.imageloader.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.iss.imageloader.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.iss.imageloader.core.imageaware.ImageAware
     ...
     * {@link android.widget.ImageView ImageView}.
     *
     * @param imageView {@link android.widget.ImageView ImageView} for which
     *            display task will be cancelled
     */
