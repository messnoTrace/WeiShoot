...
public class LoadingLayout extends FrameLayout {
    ...
    private final RelativeLayout pull_to_refresh_layout;
    ...
    public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel,
        ...
        switch (type) {
            ...
            case 1:
                header = (ViewGroup) LayoutInflater.from(context).inflate(
                        R.layout.pull_to_load_footer, this);
                break;
        }
        ...
        pull_to_refresh_layout = (RelativeLayout) header.findViewById(R.id.pull_to_refresh_layout);
        ...
        if (attrs.hasValue(R.styleable.PullToRefresh_ptrHeaderTextColor)) {
            final int color = attrs.getColor(R.styleable.PullToRefresh_ptrHeaderTextColor,
                    Color.BLACK);
            setTextColor(color);
        }
    }
    ...
    public void reset() {
        ...
        pull_to_refresh_layout.setVisibility(View.GONE);
    }
    ...
    public void refreshing() {
        ...
        pull_to_refresh_layout.setVisibility(View.VISIBLE);
    }
