...
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.FailReason.FailType;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.ImageScaleType;
...
import com.NationalPhotograpy.weishoot.utils.imageloader.core.decode.ImageDecodingInfo;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.download.ImageDownloader;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.download.ImageDownloader.Scheme;
...
import com.NationalPhotograpy.weishoot.utils.imageloader.utils.IoUtils;
 ...
 * {@link com.iss.imageloader.core.imageaware.ImageAware} using
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    private Bitmap tryLoadBitmap() throws TaskCancelledException {
        ...
        try {
            ...
            if (bitmap == null || bitmap.getWidth() <= 0 || bitmap.getHeight() <= 0) {
                ...
                String imageUriForDecoding = options.isCacheOnDisc()
                        && tryCacheImageOnDisc(imageFile) ? cacheFileUri : uri;
    ...
    private Bitmap decodeImage(String imageUri) throws IOException {
        ...
        ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey, imageUri,
                targetSize, viewScaleType, getDownloader(), options);
        ...
        try {
            ...
            if (loaded) {
                ...
                if (width > 0 || height > 0) {
                    ...
                    loaded = resizeAndSaveImage(targetFile, width, height); // TODO
                                                                            // :
                                                                            // process
                                                                            // boolean
                                                                            // result
