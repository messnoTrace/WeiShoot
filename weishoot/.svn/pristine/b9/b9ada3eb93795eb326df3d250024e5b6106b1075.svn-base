...
package com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.impl;

import java.io.File;

import com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.LimitedDiscCache;
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.naming.FileNameGenerator;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.DefaultConfigurationFactory;
...
public class TotalSizeLimitedDiscCache extends LimitedDiscCache {
    ...
    public TotalSizeLimitedDiscCache(File cacheDir, FileNameGenerator fileNameGenerator,
        ...
        if (maxCacheSize < MIN_NORMAL_CACHE_SIZE) {
            L.w("You set too small disc cache size (less than %1$d Mb)",
