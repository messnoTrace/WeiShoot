...
public class PullToZoomListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private OnPullDownHeightListener pullDownHeightListener;
    ...
    private void init(Context paramContext) {
        ...
        setHeaderViewSize(i, (int) DimensionPixelUtil.getDimensionPixelSize(1, 250, paramContext));
    ...
    public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3) {
        Log.d("mmm", "onScroll " + this.mHeaderContainer.getBottom());
        float f = this.mHeaderHeight - this.mHeaderContainer.getBottom();
        if (mHeaderView != null && f < 0) {
            mHeaderView.scrollTo(0, (int) (f));
        }
        Log.d("mmm", "sssssf|" + f);
        downHeight = (int) f;
        ...
        if (this.pullDownHeightListener != null) {
            this.pullDownHeightListener.pullDownHeight(this.mHeaderContainer.getBottom());
        }

    }

    public void setOnPullDownHeightListener(OnPullDownHeightListener listener) {
        this.pullDownHeightListener = listener;
    }

    public static interface OnPullDownHeightListener {
        void pullDownHeight(int height);
    }
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent) {
        ...
        switch (0xFF & paramMotionEvent.getAction()) {
            ...
            case 2:
                ...
                if (j == -1) {
                    Log.e("PullToZoomListView", "Invalid pointerId=" + this.mActivePointerId
                            + " in onTouchEvent");
                } else {
            ...
            case 1:
                reset();
                endScraling();
                if (this.downHeight < -20 && pullDownListener != null) {
                    this.pullDownListener.pullDown();
                }
