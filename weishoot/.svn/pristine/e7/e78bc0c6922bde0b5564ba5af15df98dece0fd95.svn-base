...
public class FailReason {
    ...
    public static enum FailType {
        ...
        DECODING_ERROR,
        /**
         * {@linkplain com.nostra13.universalimageloader.core.ImageLoader#denyNetworkDownloads(boolean)
         * Network downloads are denied} and requested image wasn't cached in
         * disc cache before.
         */
        NETWORK_DENIED,
