...
public class ZambiaListAdapter extends BaseSwipeAdapter {
    private Context con;
    ...
    public ZambiaListAdapter(Context con) {
        super();
        this.con = con;
    ...
    private void setConvertView(ViewHolder holder, int position) {
        ...
        if (!TextUtils.isEmpty(zamBias.get(position).NickName)) {
            holder.tv_user_name.setText(zamBias.get(position).NickName);
        }
        if (!TextUtils.isEmpty(zamBias.get(position).Introduction)) {
                            ...
                            try {
                                ...
                                if ("200".equals(obj.optString("ResultCode"))) {
                                    ...
                                    if ("0".equals(zamBias.get(position).IsAttention)) {
                                        ...
                                        WeiShootToast.makeText(con, "关注成功", WeiShootToast.LENGTH_SHORT).show();
                                        ...
                                        WeiShootToast.makeText(con, "取消关注", WeiShootToast.LENGTH_SHORT).show();
                                    }
                                    notifyDataSetChanged();
