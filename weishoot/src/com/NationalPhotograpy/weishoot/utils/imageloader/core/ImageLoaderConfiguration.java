...
package com.NationalPhotograpy.weishoot.utils.imageloader.core;
...
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.DiscCacheAware;
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.impl.UnlimitedDiscCache;
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.disc.naming.FileNameGenerator;
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.memory.MemoryCacheAware;
import com.NationalPhotograpy.weishoot.utils.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.ImageSize;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.assist.QueueProcessingType;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.decode.ImageDecoder;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.download.ImageDownloader;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.download.NetworkDeniedImageDownloader;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.download.SlowNetworkImageDownloader;
import com.NationalPhotograpy.weishoot.utils.imageloader.core.process.BitmapProcessor;
import com.NationalPhotograpy.weishoot.utils.imageloader.utils.L;
import com.NationalPhotograpy.weishoot.utils.imageloader.utils.MemoryCacheUtils;
import com.NationalPhotograpy.weishoot.utils.imageloader.utils.StorageUtils;
...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
         ...
         *
         * @param maxImageWidthForMemoryCache Maximum image width which will be
         *            used for memory saving during decoding an image to
         *            {@link android.graphics.Bitmap Bitmap}. <b>Default value -
         *            device's screen width</b>
         * @param maxImageHeightForMemoryCache Maximum image height which will
         *            be used for memory saving during decoding an image to
         ...
         *
         * @param maxImageWidthForDiscCache Maximum width of downloaded images
         *            for saving at disc cache
         * @param maxImageHeightForDiscCache Maximum height of downloaded images
         *            for saving at disc cache
         * @param compressFormat {@link android.graphics.Bitmap.CompressFormat
         *            Compress format} downloaded images to save them at disc
         *            cache
         * @param compressQuality Hint to the compressor, 0-100. 0 meaning
         *            compress for small size, 100 meaning compress for max
         *            quality. Some formats, like PNG which is lossless, will
         *            ignore the quality setting
         * @param processorForDiscCache null-ok; {@linkplain BitmapProcessor
         *            Bitmap processor} which process images before saving them
         *            in disc cache
         */
        public Builder discCacheExtraOptions(int maxImageWidthForDiscCache,
                int maxImageHeightForDiscCache, CompressFormat compressFormat, int compressQuality,
         ...
         * {@link com.iss.imageloader.cache.memory.impl.LruMemoryCache
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.iss.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache
         ...
         * By default: disc cache is unlimited.<br />
         * <b>NOTE:</b> If you use this method then
         * {@link com.iss.imageloader.cache.disc.impl.FileCountLimitedDiscCache
         ...
         * Default value -
         * {@link com.iss.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
         ...
         * Default value -
         * {@link com.iss.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.iss.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Default value -
         * {@link com.iss.imageloader.cache.disc.impl.UnlimitedDiscCache
         * UnlimitedDiscCache}. Cache directory is defined by
         * {@link com.iss.imageloader.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * {@link com.iss.imageloader.utils.L#disableLogging()} to disable
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (taskExecutorForCachedImages == null) {
                taskExecutorForCachedImages = DefaultConfigurationFactory.createExecutor(
            ...
            if (discCache == null) {
                ...
                discCache = DefaultConfigurationFactory.createDiscCache(context,
                        discCacheFileNameGenerator, discCacheSize, discCacheFileCount);
            }
            if (memoryCache == null) {
