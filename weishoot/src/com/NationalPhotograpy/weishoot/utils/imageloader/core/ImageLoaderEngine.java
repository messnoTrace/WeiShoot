...
class ImageLoaderEngine {
    ...
    void submit(final LoadAndDisplayImageTask task) {
        taskDistributor.execute(new Runnable() {
            @Override
            public void run() {
                boolean isImageCachedOnDisc = configuration.discCache.get(task.getLoadingUri())
                        .exists();
                initExecutorsIfNeed();
     ...
     * {@link com.iss.imageloader.core.imageaware.ImageAware}
     */
    ...
    /**
     * Associates <b>memoryCacheKey</b> with <b>imageAware</b>. Then it helps to
     * define image URI is loaded into View at exact moment.
     */
     ...
     *            for which display task will be cancelled
     */
