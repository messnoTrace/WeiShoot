...
package com.NationalPhotograpy.weishoot.utils.imageloader.core.decode;
...
public class BaseImageDecoder implements ImageDecoder {
     ...
     *            {@link com.iss.imageloader.core.ImageLoaderConfiguration.Builder#writeDebugLogs()
    ...
    public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException {
        ...
        if (decodedBitmap == null) {
            ...
            decodedBitmap = considerExactScaleAndOrientaiton(decodedBitmap, decodingInfo,
    ...
    private boolean canDefineExifParams(String imageUri, String mimeType) {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.ECLAIR
                && "image/jpeg".equalsIgnoreCase(mimeType) && Scheme.ofUri(imageUri) == Scheme.FILE;
    }
    ...
    protected Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo decodingInfo) {
        ...
        if (scaleType == ImageScaleType.NONE) {
            ...
            scale = ImageSizeUtils.computeImageSampleSize(imageSize, targetSize,
                    decodingInfo.getViewScaleType(), powerOf2);
        }
        if (scale > 1 && loggingEnabled) {
            L.d(LOG_SABSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale), scale,
    ...
    protected Bitmap considerExactScaleAndOrientaiton(Bitmap subsampledBitmap,
        ...
        Bitmap finalBitmap = Bitmap.createBitmap(subsampledBitmap, 0, 0,
                subsampledBitmap.getWidth(), subsampledBitmap.getHeight(), m, true);
