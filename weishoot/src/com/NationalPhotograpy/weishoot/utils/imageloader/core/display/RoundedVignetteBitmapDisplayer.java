...
/**
 * Can display bitmap with rounded corners and vignette effect. This
 * implementation works only with ImageViews wrapped in ImageViewAware. <br />
    ...
    protected static class RoundedVignetteDrawable extends RoundedDrawable {
        ...
        protected void onBoundsChange(Rect bounds) {
            ...
            RadialGradient vignette = new RadialGradient(mRect.centerX(),
                    mRect.centerY() * 1.0f / 0.7f, mRect.centerX() * 1.3f, new int[] {
                            0, 0, 0x7f000000
                    }, new float[] {
                            0.0f, 0.7f, 1.0f
