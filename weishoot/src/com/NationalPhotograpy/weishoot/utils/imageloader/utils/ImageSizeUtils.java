...
package com.NationalPhotograpy.weishoot.utils.imageloader.utils;
...
public final class ImageSizeUtils {
     ...
     * {@link com.iss.imageloader.core.imageaware.ImageAware view} parameters,
     ...
     * @param viewScaleType {@linkplain ViewScaleType Scale type} for placing
     *            image in view
     * @param powerOf2Scale <i>true</i> - if sample size be a power of 2 (1, 2,
     *            4, 8, ...)
    ...
    /**
     * Computes minimal sample size for downscaling image so result image size
     * won't exceed max acceptable OpenGL texture size.<br />
     * We can't create Bitmap in memory with size exceed max texture size
     * (usually this is 2048x2048) so this method calculate minimal sample size
     * which should be applied to image to fit into these limits.
     *
     * @param srcSize Original image size
     ...
     * @param viewScaleType {@linkplain ViewScaleType Scale type} for placing
     *            image in view
     * @param stretch Whether source size should be stretched if target size is
