...
package com.NationalPhotograpy.weishoot.view.pullrefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // Add Loading Views
        if (mMode == MODE_PULL_DOWN_TO_REFRESH || mMode == MODE_BOTH) {
            mHeaderLayout = new LoadingLayout(context, MODE_PULL_DOWN_TO_REFRESH,
                    releaseToRefreshLabel, pullToRefreshLabel, refreshingLabel, a, 0);
        ...
        if (mMode == MODE_PULL_UP_TO_REFRESH || mMode == MODE_BOTH) {
            mFooterLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseToLoadLabel,
                    pullToLoadLabel, loadingLabel, a, 1);
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrHeaderBackground)) {
            setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_ptrHeaderBackground,
                    Color.WHITE));
        }
        if (a.hasValue(R.styleable.PullToRefresh_ptrAdapterViewBackground)) {
            mRefreshableView.setBackgroundResource(a.getResourceId(
                    R.styleable.PullToRefresh_ptrAdapterViewBackground, Color.WHITE));
        }
        a.recycle();
        a = null;
